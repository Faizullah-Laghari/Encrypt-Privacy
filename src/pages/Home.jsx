      ...
      <section className="py-[30px] pr-[20px] h-[100vh] flex-1">
        <div className="h-full bg-[#191919] overflow-auto no-scrollbar rounded-[30px] p-[30px]">
          <header className="flex items-center justify-between">
            <h1 className="text-[32px] text-[#fff] font-bold">Dashboard</h1>
          ...
          <div className="grid grid-cols-[1fr_.5fr_.8fr] gap-[25px] mt-10">
            <div className="bg-[#323233] p-[25px] rounded-[30px]">
              <h1 className="text-[24px] font-bold text-[#fff]">
                Estimated Balance
              </h1>

              <div className="my-[30px] flex items-center gap-[15px]">
                <h1 className="text-[30px] font-bold text-[#fff] 3xl:text-[25px]">
                  0.812313 BTC
                </h1>
                <img src={arrowBtn} alt="" />
                <p className="flex items-center text-[30px] 3xl:text-[25px] font-bold text-[#7F8083]">
                  <img src={tilt} alt="" />
                  $20,234
                </p>
              </div>

              <div className="inline-flex items-center bg-[#19191A] p-[5px] rounded-[10px] gap-[5px]">
          ...
          <div className="grid grid-cols-3 gap-[25px] mt-10">
            <div className="bg-[#323233] p-[25px] rounded-[30px] col-span-2">
              <div className="flex items-center justify-between mb-[15px]">
                <h1 className="text-[24px] font-bold text-[#fff]">Markets</h1>
                <div className="flex items-center bg-[#19191A] p-[5px] rounded-[10px] gap-[5px]">
                  <button className="font-montserrat text-[16px] text-[#fff] rounded-[5px] w-[116px] h-[30px] btn-gradient">
                    Holding
                  </button>
                  <button className="font-montserrat text-[16px] text-[#7F8083] bg-[#323233] rounded-[5px] w-[116px] h-[30px]">
          ...
          <div className="grid grid-cols-5 3xl:grid-cols-4 gap-[25px] mt-10">
